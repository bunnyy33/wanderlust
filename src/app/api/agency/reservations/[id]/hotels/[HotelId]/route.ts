...
// PUT /api/agency/reservations/[id]/hotels/[HotelId]
export async function PUT(req: NextRequest, { params }: ctx) {
  ...
  try {
    ...
    if (body.checkOutDate !== undefined)
      data.checkOutDate = body.checkOutDate ? new Date(body.checkOutDate) : existing.checkOutDate;
    ...
    if (body.confirmationNumber !== undefined)
      data.confirmationNumber = body.confirmationNumber ? String(body.confirmationNumber) : null;
...
// DELETE /api/agency/reservations/[id]/hotels/[HotelId]
